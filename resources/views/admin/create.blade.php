...
<div class="min-h-screen bg-gray-100">
    ...
    <!-- Page Content -->
    <main class="admin__main flex flex-col justify-center my-4" style="min-height: 90vh;">
        <div class="container">
            <form action="{{route('admin.productStore')}}" method="post" class="max-w-max text-white" enctype="multipart/form-data">
                @csrf
